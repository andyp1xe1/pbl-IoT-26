...
|------|------|--------|---|-------|------|-------------|-------|
| E01 | Project Foundation | Not Started | 0 | — | `docs/plans/01-scaffolding.md` | 2026-04-21 | PlatformIO scaffold + lib stubs |
| E02 | HW Abstraction Layer | Not Started | 0 | — | `docs/plans/01-scaffolding.md` | 2026-04-21 | Interface contracts for dd_* |
| E03 | IMU Driver (dd_mpu6050) | Not Started | 0 | — | `docs/plans/02-dd-mpu6050.md` | 2026-04-21 | I²C, WHO_AM_I, scaled reads |
