 ...
 *
 * PINKY  — capacitive touch pad (ESP32 T0, GPIO4). Bare electrode/wire.
 ...
 * RING   — tactile push-button, one leg to GPIO15, other leg to GND.
 * MIDDLE — tactile push-button, one leg to GPIO13, other leg to GND.
 ...
 *          needed. */
#define AG_TOUCH_PINKY   0   /* T0  / GPIO4  — capacitive             */
#define AG_TOUCH_INDEX   6   /* T6  / GPIO14 — button (INPUT_PULLUP)  */
#define AG_TOUCH_RING    3   /* T3  / GPIO15 — button (INPUT_PULLUP)  */
#define AG_TOUCH_MIDDLE  4   /* T4  / GPIO13 — button (INPUT_PULLUP)  */
